...
* @{
*/
#define PRODUCT_KEY "61349ba9c0064f60bb9d087c1c1c17ef"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "d05b0ebb65c14ec28b4ee2345fe0282b"
...
* @{
*/
#define low_hearts_LEN                           1
#define high_hearts_LEN                           1
#define low_blood_pressure_LEN                           1
#define high_blood_pressure_LEN                           1
...
#define spo2_MAX                           100
#define spo2_LEN                           1
#define Systolic_RATIO                         1
#define Systolic_ADDITION                      0
#define Systolic_MIN                           0
#define Systolic_MAX                           200
#define Systolic_LEN                           1
#define Diastole_RATIO                         1
#define Diastole_ADDITION                      0
#define Diastole_MIN                           0
#define Diastole_MAX                           200
#define Diastole_LEN                           1
#define hearts_RATIO                         1
#define hearts_ADDITION                      0
#define hearts_MIN                           0
#define hearts_MAX                           300
#define hearts_LEN                           2
#define jingdu_RATIO                         0.01
#define jingdu_ADDITION                      73.33
#define jingdu_MIN                           0
#define jingdu_MAX                           6172
#define jingdu_LEN                           2
#define weidu_RATIO                         0.01
#define weidu_ADDITION                      3.51
#define weidu_MIN                           0
#define weidu_MAX                           4982
#define weidu_LEN                           2
...
typedef struct {
  bool valuelow_hearts;
  bool valuehigh_hearts;
  bool valuelow_blood_pressure;
  bool valuehigh_blood_pressure;
  uint32_t valuespo2;
  uint32_t valueSystolic;
  uint32_t valueDiastole;
  uint32_t valuehearts;
  float valuejingdu;
  float valueweidu;
...
/** User Area Device State Structure */
typedef struct {
  uint8_t flaglow_hearts:1;
  uint8_t flaghigh_hearts:1;
  uint8_t flaglow_blood_pressure:1;
  uint8_t flaghigh_blood_pressure:1;
  uint8_t flagspo2:1;
  uint8_t flagSystolic:1;
  uint8_t flagDiastole:1;
  uint8_t flaghearts:1;
  uint8_t flagjingdu:1;
  uint8_t flagweidu:1;
...
typedef struct {
  ...
  uint8_t valuespo2;
  uint8_t valueSystolic;
  uint8_t valueDiastole;
  uint16_t valuehearts;
  uint16_t valuejingdu;
  uint16_t valueweidu;
