...
* @{
*/
#define PRODUCT_KEY "8a0492ad79244e4a902936fdff09013d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "70f5e38c3666423392bdab41c1b6624e"
...
#define weidu_LEN                           2
#define start_jing_RATIO                         0.01
#define start_jing_ADDITION                      73.33
#define start_jing_MIN                           0
#define start_jing_MAX                           6172
#define start_jing_LEN                           2
#define start_wei_RATIO                         0.01
#define start_wei_ADDITION                      3.51
#define start_wei_MIN                           0
#define start_wei_MAX                           4982
#define start_wei_LEN                           2
#define end_jing_RATIO                         0.01
#define end_jing_ADDITION                      73.33
#define end_jing_MIN                           0
#define end_jing_MAX                           6172
#define end_jing_LEN                           2
#define end_wei_RATIO                         0.01
#define end_wei_ADDITION                      3.51
#define end_wei_MIN                           0
#define end_wei_MAX                           4982
#define end_wei_LEN                           2
...
typedef struct {
  ...
  float valuejingdu;
  float valueweidu;
  float valuestart_jing;
  float valuestart_wei;
  float valueend_jing;
  float valueend_wei;
} dataPoint_t;
...
/** User Area Device State Structure */
typedef struct {
  uint8_t flagwarn_flag:1;
  uint8_t flagjingdu:1;
  uint8_t flagweidu:1;
  uint8_t flagstart_jing:1;
  uint8_t flagstart_wei:1;
  uint8_t flagend_jing:1;
  uint8_t flagend_wei:1;
} dataPointFlags_t;
...
typedef struct {
  ...
  uint16_t valueweidu;
  uint16_t valuestart_jing;
  uint16_t valuestart_wei;
  uint16_t valueend_jing;
  uint16_t valueend_wei;
} devStatus_t;
